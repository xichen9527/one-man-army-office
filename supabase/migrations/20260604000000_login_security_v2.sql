-- Cleanup existing broken tables first
...
CREATE INDEX idx_account_locks_user_id
  ON public.account_locks(user_id, is_active);
CREATE INDEX idx_account_locks_identifier
  ON public.account_locks(user_identifier, is_active);
CREATE INDEX idx_account_locks_active
